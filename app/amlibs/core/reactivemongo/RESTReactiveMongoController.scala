//package amlibs.core.reactivemongo
//
...
//}
//
//abstract class ReactiveMongoRESTController[T](implicit ctx: ExecutionContext, format: Format[T])
//  extends RESTRouterContoller[BSONObjectID]
